...
* Trigger events by user's actions, such as App launch. 
  * See [Auto Events]({% link docs/AutoEvents.md %}) and Customized Events ([iOS](docs/iOS.md#set-up-customized-events), [Android](% link docs/Android.md#set-up-customized-events %)) for more details.
